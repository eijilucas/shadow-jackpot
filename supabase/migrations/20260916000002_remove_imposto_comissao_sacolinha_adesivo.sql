-- ----------------------------------------------------------------------------
-- Remove imposto, comissão de influencer, sacolinha e adesivo do cálculo de
-- margem — deixaram de ser cobrados. As colunas continuam em
-- sale_fee_rates (histórico, e pra não quebrar o tipo FeeRatesRow), só não
-- entram mais na conta de sale_cost/direct_cost.
-- ----------------------------------------------------------------------------
