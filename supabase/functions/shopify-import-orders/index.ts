...
async function ensureProductCostStubs(
  ...
  // Peça nova nasce em R$115 (o "custo base", antes de bater o volume que
  // justifica preço de fábrica melhor) — o trigger apply_volume_discount
  // em sale_revenue baixa pra R$69 sozinho assim que a peça passar de 25
  // vendas. Ver migração 20260922000001_volume_discount_trigger.
